...
const BillDraftMake = ({ isDialogOpen, handleDialogClose, billMasterID, pONo, workTitle, bmJoin, submarineCableName, issueDateDefault, dueDateDefault, tmpBMArray }) => {
                        ...
                        fetch(generateBillData, {
                                ...
                                .then((data) => {
                                        ...
                                        data.DetailInformation.forEach((i) => {
                                                totalAmount.current = new Decimal(totalAmount.current).toDecimalPlaces(2).add(new Decimal(i.ShareAmount).toDecimalPlaces(2));
                                        });
                                })
                                .catch(() => {
                                        dispatch(
                                                                                ...
                                                                                <TableBody>
                                                                                        ...
                                                                                        <TableRow>
                                                                                                ...
                                                                                                <StyledTableCell align="right" className="totalAmountSecond">
                                                                                                        {isTax.current ? null : handleNumber(totalAmount.current?.toFixed(2))}
                                                                                                </StyledTableCell>
                                                                                                <StyledTableCell align="right" className="totalAmountSecond">
                                                                                                        {isTax.current ? handleNumber(totalAmount.current?.toFixed(2)) : null}
                                                                                                </StyledTableCell>
